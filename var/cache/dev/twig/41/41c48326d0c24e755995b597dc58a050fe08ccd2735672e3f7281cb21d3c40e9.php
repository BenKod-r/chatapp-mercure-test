...
class __TwigTemplate_bc20cb6cd6370f2373d7dbf28c10be4f9836d441dd91063a5eaa2ee5381189e2 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 class=\"mt-2 text-white text-center\">
        Chat test with the mercure protocol on the Symfony framework
    </h1>
    <div class=\"container d-flex justify-content-between mb-5 mt-5\">
        ";
        // line 10
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            // line 11
            echo "            ";
            if (0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 11), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11), "id", [], "any", false, false, false, 11))) {
                // line 12
                echo "                <a class=\"btn btn-primary\" href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("conversations.create.conversation", ["user" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 12)]), "html", null, true);
                echo "\">";
        ...
        // line 15
        echo "    </div>
    <h1 class=\"mt-2 text-white text-center\">
        Hello ";
        // line 17
...
";
    ...
    {
        return array (  147 => 23,  137 => 22,  125 => 19,  120 => 17,  116 => 15,  110 => 14,  102 => 12,  99 => 11,  95 => 10,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
    ...
    <div class=\"container d-flex justify-content-between mb-5 mt-5\">
        {% for user in users %}
            {% if user.id != app.user.id %}
                <a class=\"btn btn-primary\" href=\"{{ path('conversations.create.conversation', {user: user.id}) }}\">{{ user.username }}</a>
            {% endif %}
        {% endfor %}
    </div>
    <h1 class=\"mt-2 text-white text-center\">
...
{% endblock %}
", "index/index.html.twig", "/home/benkod/Benkod-r/Test/chatapp-mercure-test/templates/index/index.html.twig");
    }
}
